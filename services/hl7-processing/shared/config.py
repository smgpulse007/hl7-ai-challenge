...
def load_environment_config():
    ...
    if env == "production":
        ...
        config.database.host = os.getenv("PROD_DB_HOST", "prod-db.iehp.local")
        config.redis.host = os.getenv("PROD_REDIS_HOST", "prod-redis.iehp.local")
        ...
        # Staging overrides
        config.database.host = os.getenv("STAGING_DB_HOST", "staging-db.iehp.local")
        config.redis.host = os.getenv("STAGING_REDIS_HOST", "staging-redis.iehp.local")
